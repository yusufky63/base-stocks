...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: "Who executes my trade?", a: "Every quote is requested from several routes at once: KyberSwap, Velora, the Uniswap Trading API, Aerodrome directly, and 0x or OKX when they are enabled. BaseStocks shows every answer, picks the best net output by default, and lets you choose a provider. The swap itself is a transaction your wallet signs. Turn on best execution and CoW Protocol's batch auction takes the trade whenever it is within half a percent of the best swap: no gas, no front-running, and the panel suggests it for larger orders." },
