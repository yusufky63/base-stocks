...
const FAQ: Array<{ q: string; a: string }> = [
  ...
  { q: "What if a stock in my plan cannot be bought one week?", a: "That leg is skipped for that run — its share simply stays in your wallet — and the plan keeps its schedule. The same rule that labels a stock Not issued, No pool or Paused on Markets decides this, and a leg that would be more than 2% of its pool is skipped too rather than filled at a bad price." },
