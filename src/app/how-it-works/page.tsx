...
import { BarChart3, Blocks, Bot, Gift, Landmark, LineChart, Newspaper, PieChart, Repeat, ShieldCheck, Sprout, Users } from "lucide-react";
...
const FEATURES = [
  ...
  { icon: BarChart3, title: "Trade", body: "Every quote asks KyberSwap, Velora, Uniswap, Aerodrome and, when enabled, 0x and OKX at once; you pick auto (best net) or a provider. Pay with USDC or ETH.", href: "/markets" },
...
const STEPS = [
  ...
  { n: "06", title: "Send or earn", body: "Send stock to a Basename like alice.base.eth or a 0x address; the resolved address is always shown before you confirm. Earn venues are discovered at runtime and hidden when none exist.", detail: "USDC deposits into Morpho, Aave V3 and Compound v3 run in-app; pools open on the venue while positions stay tracked here." },
];
