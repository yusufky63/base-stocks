...
const FEATURES = [
  ...
  { icon: Bot, title: "Assistant, fenced", body: "Drafts baskets and plans from live tickers, liquidity, the shared brief and recent headlines, and says why — thesis, each leg, the risks, the headlines it leaned on. It cannot sign, approve or pick addresses, and it explains rather than recommends.", href: "/build" },
...
const STEPS = [
  ...
  { n: "05", title: "Build & automate", body: "Compose a basket with sliders, a template or a guided AI draft. Each leg is a separate trade you confirm; if one fails, the completed ones stay and you can retry the rest.", detail: "Plans repeat a buy or a basket on a schedule. An automatic plan runs by itself: the contract pulls one run's USDC under an allowance you set, swaps it with you as the recipient and checks what you received against the Chainlink reference. A manual plan proposes a run and waits for your wallet." },
