...
/**
 * Site-wide share card, in the app's own visual language: white canvas, a bordered card with the
 * signature blue tick brackets, a brand lockup, Space Grotesk headline and a cluster of the real
 * stock coins on the right. Static content (no data fetch) so it never fails.
 */
